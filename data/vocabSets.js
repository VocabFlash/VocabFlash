...
const vocabSets= {
  ...
  set3: [
    ...
    { "de": "Keine Sorge!; Mach dir keine Sorgen!", "ar": "T’inquiète ! (fam.)" },
    ...
    { "de": "auftauchen (ugs.)", "ar": "rappliquer (fam.)" },
    ...
    { "de": "eine Katastrophe", "ar": "une cata (fam.)" },
    ...
    { "de": "begeistert", "ar": "emballé/emballée (fam.)" },
    { "de": "klar; natürlich", "ar": "évidemment" },
    { "de": "Das ist stinklangweilig.", "ar": "C'est rasoir. (fam.)" },
